    ...
    <section id="about" className="py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-24">
          <h2 className="text-5xl md:text-6xl font-light text-gray-900 mb-8">About</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-24">
          <div className="text-center">
            ...
            <h3 className="text-2xl font-medium text-gray-900 mb-6">Vision</h3>
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-purple-100 rounded-2xl mb-8">
              <Target className="w-8 h-8 text-purple-600" />
            </div>
            <h3 className="text-2xl font-medium text-gray-900 mb-6">Mission</h3>
            <p className="text-gray-600 leading-relaxed font-light">
          ...
          <div className="text-center">
            <div className="inline-flex items-center justify-center w-16 h-16 bg-green-100 rounded-2xl mb-8">
        ...
        <div className="bg-gray-50 p-16 rounded-3xl">
          <h3 className="text-3xl font-light text-gray-900 mb-8 text-center">Plan for a Centralized Society</h3>
          <p className="text-gray-600 leading-relaxed mb-12 text-center max-w-4xl mx-auto text-lg font-light">
          ...
          <p className="text-blue-600 text-center mt-12 text-lg font-medium">
